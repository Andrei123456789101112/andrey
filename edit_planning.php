...
<head>
    ...
    <title>List of Succession</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        <div class="container">
        <a class="navbar-brand" href="planning.php"><img src="logo.png" alt="ATS Logo" height="100" width="100"></a>
            <a class="navbar-brand" href="planning.php">Succession Planning</a>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            if (mysqli_query($conn, $sql)) {
                header("Location: view_planning.php?id=$id");
                exit();
            } else {
