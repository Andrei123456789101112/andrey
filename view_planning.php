...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        <div class="container">
        <a class="navbar-brand" href="index.php"><img src="logo.png" alt="ATS Logo" height="100" width="100"></a>
    ...
    <div class="container mt-5">
        ...
        <a href="edit_planning.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
        <a href="delete_planning.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
    </div>
</body>
</html>
